        ...
        public string UserChoice()
        {
            ...
            switch (userInput)
            {
                ...
                case "1":
                    ...
                    while (inputproductID == "" || listInventory.All(p => p.ProductID != Convert.ToInt32(inputproductID)))
                    {
                    ...
                    if (listInventory.Find(p => p.ProductID == Convert.ToInt32(inputproductID)).Quantity < Convert.ToInt32(inputQuantity))
                    {
